...
export const maintenanceTasks = [
  ...
  { id: 'mini-split-filters', title: 'Clean mini split filters on all 4 heads', area: 'HVAC', category: 'Systems', room: 'Whole home', system: 'HVAC', assetName: '4-head mini split heat pump', vendor: '', supplyNote: 'Filter cleaning spray, towels', frequency: 'Monthly', cadenceDays: 30, reminderLeadDays: 7, effort: '35 min', season: 'All year', priority: 'Important', notes: 'Open covers, wash filters gently, fully dry, reinstall.', lastDone: '2026-03-01', major: false },
