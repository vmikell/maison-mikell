...
## Will this price come back later?

Recommended answer:
No. The founding offer is meant to be a limited launch window, not an always-open discount.
...
## Does one subscription cover one person or one household?

Recommended product answer:
One subscription should cover one household.

This should be finalized in billing and legal copy before launch.

## Why offer lifetime access at launch?
...
When using this FAQ in public copy:
- sound calm and confident
- avoid hard-sell pressure
- avoid fake urgency
- present the founding offer as limited, but real
