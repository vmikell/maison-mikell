...
fs.writeFileSync('/home/vboxuser/.openclaw/workspace/projects/home-maintenance-planner/calendar-sync-preview.json', JSON.stringify(items, null, 2))
console.log(`Exported ${items.length} reminder-backed calendar items.`)
